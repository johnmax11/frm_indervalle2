...
namespace MiProyecto{
    ...
    require_once ($_SESSION[$_SESSION['_SFT_NAME_']]['CONFIG_SITE']['PATH_APLICATION'].'/aplication/model/cl_vo/vo_log_errores_principal.php');
    /**
     * Description of vo_log_errores_principal
     *
     * @author John Jairo Cortes Garcia - johnjairo1984@gmail.com
     * @version: 1.0.0
     * Fecha - 24-03-2012
     */
    class dao_log_errores_principal extends Conexion{
        /*put your code here*/
        public
            $_bolResultado,
            $_r_obj_mat = true,
