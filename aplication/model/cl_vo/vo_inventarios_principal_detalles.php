...
namespace MiProyecto{
     ...
     */
    class vo_inventarios_principal_detalles{

        private $_id;
        private $_inventarios_principal_id;
        private $_inventarios_bodegas_id;
        private $_estado;
        ...
        public function set_inventarios_principal_id($inventarios_principal_id){
                $this->_inventarios_principal_id = $inventarios_principal_id;
        }

        public function set_inventarios_bodegas_id($inventarios_bodegas_id){
                $this->_inventarios_bodegas_id = $inventarios_bodegas_id;
        }
        ...
        public function get_inventarios_principal_id(){
                return $this->_inventarios_principal_id;
        }

        public function get_inventarios_bodegas_id(){
                return $this->_inventarios_bodegas_id;
        }
