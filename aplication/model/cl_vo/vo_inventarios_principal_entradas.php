...
namespace MiProyecto{
     ...
     */
    class vo_inventarios_principal_entradas{

        private $_id;
        private $_inventarios_principal_detalles_id;
        private $_inventarios_principal_entradas_general_id;
        ...
        public function set_inventarios_principal_entradas_general_id($inventarios_principal_entradas_general_id) {
                $this->_inventarios_principal_entradas_general_id = $inventarios_principal_entradas_general_id;
        }
        ...
        public function get_inventarios_principal_entradas_general_id() {
                return $this->_inventarios_principal_entradas_general_id;
        }
