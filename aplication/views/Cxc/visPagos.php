            ...
            <div id="divBodyAddEdit" style='font-family:verdana;font-size:9pt;'>
                <form id="frmAddEdit" action="" method="post" autocomplete="on">
                    <table class='ui-state-default ui-corner-all' style="margin-left: 25%; ">
                        ...
                        <tfoot>
                        <input type='hidden' value='' id='contadorCuotas' name='contadorCuotas'> 
                        <input type='hidden' value='' id='hdnPagosFacturasPrincipal' name='hdnPagosFacturasPrincipal'> 
                        </tfoot>
                    </table>
                </form>
            </div>
